...
version: 1.1.1
description: >
  Record time worked on a task or module. Maintains a log of actual
  hours to compare against PDP estimates and billing. Supports
  progress reports and deviation alerts. Trigger: "log time",
  "time track", "hours", "I worked on", "how much have we spent",
  "hours report".
author: fcojaviergon
license: MIT
tags: [sdlc, time-tracking, estimation, solo-founder, billing]
---
