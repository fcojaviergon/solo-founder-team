...
description: >
  ...
  execute the next pending task following project conventions. Supports
  custom frontend/backend skills. Use when the user says "implement",
  "code", "next task", "move forward", or "develop".
author: fcojaviergon
license: MIT
tags: [sdlc, implementation, solo-founder, coding, development]
---
...
- When finishing the last task in the plan, run lint check and build.
