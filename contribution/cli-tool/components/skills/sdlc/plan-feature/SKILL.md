...
version: 1.1.1
description: >
  Plan a new feature for solo founders. Analyze requirements, define scope,
  identify risks and generate an actionable implementation plan with tasks
  ordered by dependency. Integrates with PDP-driven development workflow.
  Use when the user says "I want to add...", "I need...", "plan...",
  "new feature", or "plan".
author: fcojaviergon
license: MIT
tags: [sdlc, planning, solo-founder, feature, requirements]
---
